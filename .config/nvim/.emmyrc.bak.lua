local emmysettings = {
  ...
  diagnostics = {
    disable = { "deprecated", "discard-returns", "inject-field", "missing-fields", "missing-global-doc", "need-check-nil", "param-type-not-match", "redefined-local", "unreachable-code" },
    severity = {
